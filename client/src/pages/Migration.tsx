...
export default function Migration() {
    ...
    if (sourceUrl) {
      try {
        ...
        if (pathParts.length >= 2) {
          ...
          const repoName = pathParts[1].toLowerCase().replace(/[^a-z0-9-]/g, '-');
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Dataset Migration & Analysis</h1>
        <p className="text-neutral-600 max-w-3xl">
          Migrate datasets between GitHub, Kaggle, and Hugging Face Hub. Analyze repository metrics, validate against schema, and generate comprehensive reports.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mt-4">
        <div className="lg:col-span-8">
          <div className="bg-white rounded-lg shadow-sm border border-neutral-200 p-6">
            <h2 className="text-xl font-semibold mb-6">Dataset Migration Tool</h2>
            ...
            {!showMigrationProgress ? (
              <>
                ...
                <div className="flex justify-end">
                  ...
                  <button 
                    ...
                    disabled={migrationMutation.isPending || !sourcePlatform || !sourceUrl || !repositoryName}
                    className={`inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-secondary hover:bg-secondary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-secondary ${
                      migrationMutation.isPending || !sourcePlatform || !sourceUrl || !repositoryName ? 'opacity-50 cursor-not-allowed' : ''
                    }`}
                  >
              ...
              <div className="text-center py-4">
                <p>No active migration. Start a new migration to see progress.</p>
              </div>
            )}
          </div>
        </div>
