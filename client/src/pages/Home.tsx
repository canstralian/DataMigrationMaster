    ...
    <div className="container mx-auto px-4 py-6">
      <div className="mb-8">
        ...
        <p className="text-neutral-600 max-w-3xl">
          Manage your datasets across GitHub, Kaggle, and Hugging Face Hub. Analyze repository metrics, 
          validate against schema, and generate comprehensive reports.
        </p>
      </div>
      ...
      <ToggleButton
        options={[
          ...
          },
          {
            ...
            label: (
              <div className="flex items-center">
                <svg viewBox="0 0 24 24" width="20" height="20" stroke="currentColor" strokeWidth="1.5" fill="none" className="mr-2">
          ...
          },
          {
            ...
            label: (
              <div className="flex items-center">
                <svg viewBox="0 0 120 120" width="20" height="20" fill="currentColor" className="mr-2">
