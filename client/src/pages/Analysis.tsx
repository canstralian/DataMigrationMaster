...
export default function Analysis() {
  ...
  const { data: analysisReports, isLoading: isLoadingReports } = useQuery<AnalysisReport[]>({
  ...
  const analyzeMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: [`/api/datasets/${selectedDatasetId}/analysis`] });
    },
    onError: () => {
      toast({
    ...
    <div className="container mx-auto px-4 py-6">
      <div className="mb-8">
        ...
        <p className="text-neutral-600 max-w-3xl">
          Analyze your datasets using AI-powered tools. Get insights into data quality, completeness, and usability.
        </p>
      </div>
          ...
          {cardMarkdown ? (
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-neutral-500">{selectedDataset.description || 'No description available'}</p>
              </CardHeader>
              <CardContent>
                {isLoadingReports ? (
                  ...
                  <div className="text-center py-8">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 mx-auto text-neutral-300 mb-4" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd" />
                    </svg>
                    <h3 className="text-lg font-medium mb-2">No Analysis Reports</h3>
                    <p className="text-neutral-500 mb-4 max-w-md mx-auto">
                      This dataset hasn't been analyzed yet. Run an analysis to get insights about data quality, completeness, and usability.
                    </p>
                    <Button 
                      variant="secondary"
                      onClick={handleStartAnalysis}
            ...
            <div className="bg-white rounded-lg border border-neutral-200 p-6 h-full flex flex-col items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 text-neutral-300 mb-4" viewBox="0 0 20 20" fill="currentColor">
              ...
              <p className="text-neutral-500 text-center max-w-md mb-4">
                Select a dataset from the sidebar to view its analysis or to run a new analysis using our AI-powered tools.
              </p>
              <p className="text-sm text-neutral-400">
                Dataset analysis provides insights on quality, completeness, and usability metrics.
              </p>
            </div>
          )}
        </div>
